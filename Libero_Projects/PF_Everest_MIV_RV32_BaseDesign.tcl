...
set Libero_project_name_CFG1 PF_Everest_MIV_RV32_CFG1_BaseDesign

set project_folder_name_CFG2  MIV_CFG2_BD
set project_dir_CFG2 "./$project_folder_name_CFG2"
set Libero_project_name_CFG2 PF_Everest_MIV_RV32_CFG2_BaseDesign

set project_folder_name_CFG3 MIV_CFG3_BD
set project_dir_CFG3 "./$project_folder_name_CFG3"
set Libero_project_name_CFG3 PF_Everest_MIV_RV32_CFG3_BaseDesign
...
{
	puts "\n---------------------------------------------------------------------------------------------------------"
	puts "Creating a new project for the 'PF_Everest' board."
	puts "--------------------------------------------------------------------------------------------------------- \n"
}
...
{
	puts "\n---------------------------------------------------------------------------------------------------------"
	puts "Error: A project exists for the 'PF_Everest' with this configuration."
	puts "--------------------------------------------------------------------------------------------------------- \n"
}
...
if {"$design_flow_stage" == "SYNTHESIZE"} then {
	...
	if {"$config" == "CFG1"} then {
		export_prog_job \
			-job_file_name {PF_Everest_MIV_RV32_CFG1_BaseDesign} \
		...
		export_prog_job \
			-job_file_name {PF_Everest_MIV_RV32_CFG2_BaseDesign} \
		...
		export_prog_job \
			-job_file_name {PF_Everest_MIV_RV32_CFG3_BaseDesign} \
